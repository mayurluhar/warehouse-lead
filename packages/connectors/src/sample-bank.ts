import { RawDocument, computeContentHash } from '@warehouse-lead/core';

export const BENCHMARK_SIGNALS: Omit<RawDocument, 'id' | 'contentHash' | 'fetchedAt'>[] = [
  {
...
export function getSampleDocuments(): RawDocument[] {
