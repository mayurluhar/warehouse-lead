...
import { canonicalizeUrl, computeContentHash, cleanDocumentText } from '@warehouse-lead/core';
    ...
    async fetchWarehouseFeeds() {
        ...
        for (const query of queries) {
            try {
                ...
                console.warn(`Failed fetching RSS query "${query}":`, err.message);
            }
        }
        return documents;
    }
