import { ExtractedLeadData, Intent, RequirementType, SizeInfo, LocationInfo, EvidenceQuote } from '@warehouse-lead/core';

export function extractWithHeuristics(title: string, text: string): ExtractedLeadData {
