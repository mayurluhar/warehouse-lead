 ...
 *
 * Seven business-rule components per section 6.1 of the master plan. The AI
 * extracts facts; this service decides how much to believe them. Keeping the
 * score deterministic is a deliberate product rule — an opaque LLM percentage
 * cannot be audited by a reviewer, and every component here records why it
 * awarded what it did.
 */
